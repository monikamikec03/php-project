<?php 
	...
	if ($_POST['_action_'] == FALSE) {
		print '
		<form action="" id="registration_form" name="registration_form" method="POST" onsubmit="return validateform()" method="post">
			...
			<input type="text" id="lname" name="lastname" placeholder="Your last natme..">
